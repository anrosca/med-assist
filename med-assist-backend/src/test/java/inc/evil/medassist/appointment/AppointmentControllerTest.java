...
public class AppointmentControllerTest extends AbstractRestTest {
    ...
    public void whenAppointmentEndTimeIsBeforeStartTime_shouldReturnErrorResponse() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/appointments").content(payload).contentType(
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.messages[0]",
                                                          equalTo("Field endDate with value 2021-12-12T08:45 should be after startDate, with value 2021-12-12T09:45")))
    ...
    public void whenUpdatingAppointment_AndEndTimeIsBeforeStartTime_shouldReturnErrorResponse() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/appointments/244e4567-ef9c-12d3-a45b-52661417400a").content(
                        payload).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$.messages[0]",
                                                          equalTo("Field endDate with value 2021-12-12T08:45 should be after startDate, with value 2021-12-12T09:45")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.path",
                                                          equalTo("/api/v1/appointments/244e4567-ef9c-12d3-a45b-52661417400a")));
    }
    ...
    public void shouldBeAbleToUpdateAppointments() throws Exception {
        AppointmentResponse expectedAppointment = AppointmentResponse.builder()
                ...
                .patient(PatientResponse.builder()
                                 ...
                                 .build())
                .build();
        when(appointmentFacade.update(eq("ba4e4567-bf9c-bad3-b45b-5266141740aa"), any())).thenReturn(
                expectedAppointment);
        String payload = """
                {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/appointments/ba4e4567-bf9c-bad3-b45b-5266141740aa").content(
                        payload).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.startDate", equalTo("2021-12-12T09:00")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.endDate", equalTo("2021-12-12T10:45")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.operation", equalTo("Выдача каппы")))
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.patient.id", equalTo("f44e4567-ef9c-12d3-a45b-52661417400a")))
                ...
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.doctor.id", equalTo("fa4e4567-af9c-aad3-a45b-5266141740aa")))
    ...
    public void whenAppointmentDoctorIdIsEmpty_shouldReturnErrorResponse() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/appointments").content(payload).contentType(
                ...
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$.messages[0]",
                                                          equalTo("Field 'doctorId' must not be blank but value was 'null'")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.path", equalTo("/api/v1/appointments")));
    }
    ...
    public void whenAppointmentPatientIdIsAndPatientRequestIsEmpty_shouldReturnErrorResponse() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/appointments").content(payload).contentType(
                ...
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$.messages[0]",
                                                          equalTo("Field 'patientRequest' at least should not be null but value was 'null'")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.path", equalTo("/api/v1/appointments")));
    }
    ...
    public void whenAppointmentStartDateIsNull_shouldReturnErrorResponse() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/appointments").content(payload).contentType(
                ...
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$.messages[0]",
                                                          equalTo("Field 'startDate' must not be null but value was 'null'")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.path", equalTo("/api/v1/appointments")));
    }
    ...
    public void whenAppointmentEndDateIsNull_shouldReturnErrorResponse() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/appointments").content(payload).contentType(
                ...
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$.messages[0]",
                                                          equalTo("Field 'endDate' must not be null but value was 'null'")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.path", equalTo("/api/v1/appointments")));
    }
    ...
    public void findDoctorAppointments_returnResponse() throws Exception {
        ...
        when(appointmentFacade.findAppointmentsByDoctorId("f23e4567-e89b-12d3-a456-426614174000")).thenReturn(
    ...
    public void findDoctorAppointmentsInTimeRange_returnResponse() throws Exception {
        ...
        when(appointmentFacade.findAppointmentsByDoctorIdInTimeRange("f23e4567-e89b-12d3-a456-426614174000", startDate,
                                                                     endDate)).thenReturn(expectedAppointments);

        mockMvc.perform(
                        get("/api/v1/appointments?doctorId=f23e4567-e89b-12d3-a456-426614174000&startDate=2021-12-12&endDate=2021-12-12"))
                .andExpect(status().isOk())
                .andExpect(responseBody().containsListAsJson(expectedAppointments));
    }
    ...
    public void findDoctorAppointmentsInTimeRange_whenStartDateIsInvalid_returnErrorResponse() throws Exception {
        mockMvc.perform(
                        get("/api/v1/appointments?doctorId=f23e4567-e89b-12d3-a456-426614174000&startDate=a&endDate=2021-12-12"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.path", equalTo("/api/v1/appointments")))
                .andExpect(jsonPath("$.messages[0]",
                                    equalTo("Parameter: 'startDate' is not valid. Value 'a' could not be bound to type: 'localdate'")));
    }

    @Test
    public void findDoctorAppointmentsInTimeRange_whenEndDateIsInvalid_returnErrorResponse() throws Exception {
        mockMvc.perform(
                        get("/api/v1/appointments?doctorId=f23e4567-e89b-12d3-a456-426614174000&startDate=2021-12-12&endDate=a"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.path", equalTo("/api/v1/appointments")))
                .andExpect(jsonPath("$.messages[0]",
                                    equalTo("Parameter: 'endDate' is not valid. Value 'a' could not be bound to type: 'localdate'")));
    }
}
